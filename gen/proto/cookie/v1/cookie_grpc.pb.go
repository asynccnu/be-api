...
const (
	CCNUService_SaveUser_FullMethodName  = "/cookie.v1.CCNUService/SaveUser"
	CCNUService_GetCookie_FullMethodName = "/cookie.v1.CCNUService/GetCookie"
)
...
func (c *cCNUServiceClient) SaveUser(ctx context.Context, in *SaveUserRequest, opts ...grpc.CallOption) (*SaveUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, CCNUService_SaveUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cCNUServiceClient) GetCookie(ctx context.Context, in *GetCookieRequest, opts ...grpc.CallOption) (*GetCookieResponse, error) {
	...
	err := c.cc.Invoke(ctx, CCNUService_GetCookie_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var CCNUService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cookie.v1.CCNUService",
	...
	Metadata: "proto/cookie/v1/cookie.proto",
}
